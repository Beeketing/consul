...
import (
	"github.com/Beeketing/consul/command/agent"
	"github.com/Beeketing/consul/command/catalog"
	catlistdc "github.com/Beeketing/consul/command/catalog/list/dc"
	catlistnodes "github.com/Beeketing/consul/command/catalog/list/nodes"
	catlistsvc "github.com/Beeketing/consul/command/catalog/list/services"
	"github.com/Beeketing/consul/command/connect"
	"github.com/Beeketing/consul/command/connect/ca"
	caget "github.com/Beeketing/consul/command/connect/ca/get"
	caset "github.com/Beeketing/consul/command/connect/ca/set"
	"github.com/Beeketing/consul/command/connect/proxy"
	"github.com/Beeketing/consul/command/event"
	"github.com/Beeketing/consul/command/exec"
	"github.com/Beeketing/consul/command/forceleave"
	"github.com/Beeketing/consul/command/info"
	"github.com/Beeketing/consul/command/intention"
	ixncheck "github.com/Beeketing/consul/command/intention/check"
	ixncreate "github.com/Beeketing/consul/command/intention/create"
	ixndelete "github.com/Beeketing/consul/command/intention/delete"
	ixnget "github.com/Beeketing/consul/command/intention/get"
	ixnmatch "github.com/Beeketing/consul/command/intention/match"
	"github.com/Beeketing/consul/command/join"
	"github.com/Beeketing/consul/command/keygen"
	"github.com/Beeketing/consul/command/keyring"
	"github.com/Beeketing/consul/command/kv"
	kvdel "github.com/Beeketing/consul/command/kv/del"
	kvexp "github.com/Beeketing/consul/command/kv/exp"
	kvget "github.com/Beeketing/consul/command/kv/get"
	kvimp "github.com/Beeketing/consul/command/kv/imp"
	kvput "github.com/Beeketing/consul/command/kv/put"
	"github.com/Beeketing/consul/command/leave"
	"github.com/Beeketing/consul/command/lock"
	"github.com/Beeketing/consul/command/maint"
	"github.com/Beeketing/consul/command/members"
	"github.com/Beeketing/consul/command/monitor"
	"github.com/Beeketing/consul/command/operator"
	operauto "github.com/Beeketing/consul/command/operator/autopilot"
	operautoget "github.com/Beeketing/consul/command/operator/autopilot/get"
	operautoset "github.com/Beeketing/consul/command/operator/autopilot/set"
	operraft "github.com/Beeketing/consul/command/operator/raft"
	operraftlist "github.com/Beeketing/consul/command/operator/raft/listpeers"
	operraftremove "github.com/Beeketing/consul/command/operator/raft/removepeer"
	"github.com/Beeketing/consul/command/reload"
	"github.com/Beeketing/consul/command/rtt"
	"github.com/Beeketing/consul/command/snapshot"
	snapinspect "github.com/Beeketing/consul/command/snapshot/inspect"
	snaprestore "github.com/Beeketing/consul/command/snapshot/restore"
	snapsave "github.com/Beeketing/consul/command/snapshot/save"
	"github.com/Beeketing/consul/command/validate"
	"github.com/Beeketing/consul/command/version"
	"github.com/Beeketing/consul/command/watch"
	consulversion "github.com/Beeketing/consul/version"
